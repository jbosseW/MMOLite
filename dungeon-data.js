...
// ---------------------------------------------------------------------------
// Biome to dungeon theme mapping
// ---------------------------------------------------------------------------

var BIOME_DUNGEON_THEMES = {
  0:  ['coral_grotto', 'flooded_ruins'],
  1:  ['sand_tomb', 'ancient_library'],
  2:  ['crystal_cavern', 'frozen_depths'],
  3:  ['lava_rift', 'sand_tomb'],
  4:  ['bone_yard', 'shadow_realm'],
  5:  ['fungal_forest', 'overgrown_temple'],
  6:  ['stone_keep', 'overgrown_temple'],
  7:  ['flooded_ruins', 'fungal_forest'],
  8:  ['catacombs', 'throne_dungeon'],
  9:  ['clockwork_maze', 'crystal_cavern'],
  10: ['clockwork_maze', 'armory_vault'],
  11: ['clockwork_maze', 'coral_grotto'],
};
...
// Enemies with an explicit 'element' field on their template override this.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Extend THEME_COLORS for new themes
// ---------------------------------------------------------------------------

// iron_forge: hot metal, coal-dark walls, molten orange accents
THEME_COLORS.iron_forge       = { wall: { r: 65, g: 60, b: 55 },    floor: { r: 115, g: 105, b: 95 }, accent: { r: 255, g: 140, b: 20  } };
// haunted_manor: faded velvet, crumbling plaster, ectoplasm green accents
THEME_COLORS.haunted_manor    = { wall: { r: 75, g: 65, b: 80 },    floor: { r: 130, g: 120, b: 125 }, accent: { r: 120, g: 220, b: 120 } };
// tidal_vault: deep ocean blue, barnacled stone, bioluminescent teal accents
THEME_COLORS.tidal_vault      = { wall: { r: 30, g: 55, b: 75 },    floor: { r: 60, g: 100, b: 130 },  accent: { r: 50, g: 230, b: 200  } };
// plague_warren: bile yellow, brown-grey earth, sickly green accents
THEME_COLORS.plague_warren    = { wall: { r: 60, g: 55, b: 30 },    floor: { r: 105, g: 95, b: 55 },   accent: { r: 130, g: 200, b: 40  } };
// elven_reliquary: pale ivory stone, silver-grey floor, arcane gold accents
THEME_COLORS.elven_reliquary  = { wall: { r: 100, g: 105, b: 85 },  floor: { r: 180, g: 185, b: 160 }, accent: { r: 200, g: 180, b: 60  } };
// gnomish_workshop: brass and riveted iron, gear-brown floor, electric blue accents
THEME_COLORS.gnomish_workshop = { wall: { r: 100, g: 85, b: 55 },   floor: { r: 155, g: 135, b: 90 },  accent: { r: 60, g: 180, b: 255  } };
// orc_barrow: dark red clay, bone-white floor, tribal scarlet accents
THEME_COLORS.orc_barrow       = { wall: { r: 80, g: 45, b: 35 },    floor: { r: 140, g: 110, b: 90 },  accent: { r: 200, g: 60, b: 40   } };
// mirage_palace: warm sandstone, polished marble floor, shimmering gold accents
THEME_COLORS.mirage_palace    = { wall: { r: 155, g: 130, b: 90 },  floor: { r: 210, g: 190, b: 150 }, accent: { r: 255, g: 215, b: 60  } };
// frost_citadel: deep blue ice, pale blue-white floor, crystalline silver accents
THEME_COLORS.frost_citadel    = { wall: { r: 50, g: 70, b: 105 },   floor: { r: 130, g: 160, b: 200 }, accent: { r: 210, g: 235, b: 255 } };
// goblin_warrens: muddy brown, packed-dirt floor, poison-green accents
THEME_COLORS.goblin_warrens   = { wall: { r: 65, g: 50, b: 35 },    floor: { r: 115, g: 90, b: 65 },   accent: { r: 100, g: 200, b: 60  } };
// ashen_observatory: charcoal black, light grey ash floor, ember-red accents
THEME_COLORS.ashen_observatory= { wall: { r: 45, g: 40, b: 38 },    floor: { r: 95, g: 88, b: 82 },    accent: { r: 255, g: 80, b: 30   } };
// sunken_cathedral: waterlogged limestone, grey-green floor, faded gold accents
THEME_COLORS.sunken_cathedral = { wall: { r: 60, g: 70, b: 60 },    floor: { r: 110, g: 120, b: 105 }, accent: { r: 180, g: 160, b: 55  } };
// puzzle_labyrinth: polished stone walls, tile-pattern floor, rune blue accents
THEME_COLORS.puzzle_labyrinth = { wall: { r: 80, g: 80, b: 90 },    floor: { r: 150, g: 145, b: 155 }, accent: { r: 80, g: 120, b: 200  } };
// celestial_spire: white marble walls, golden tile floor, divine gold accents
THEME_COLORS.celestial_spire = { wall: { r: 210, g: 205, b: 200 },  floor: { r: 200, g: 185, b: 140 }, accent: { r: 255, g: 220, b: 100 } };
// infernal_pit: obsidian walls, brimstone floor, hellfire orange accents
THEME_COLORS.infernal_pit    = { wall: { r: 30, g: 15, b: 15 },     floor: { r: 70, g: 40, b: 25 },    accent: { r: 255, g: 100, b: 20  } };
// dragons_den: scorched rock walls, gold-littered floor, dragon fire accents
THEME_COLORS.dragons_den     = { wall: { r: 60, g: 45, b: 35 },     floor: { r: 130, g: 110, b: 60 },  accent: { r: 255, g: 160, b: 30  } };
// vampire_castle: dark crimson walls, dark stone floor, blood red accents
THEME_COLORS.vampire_castle  = { wall: { r: 45, g: 15, b: 20 },     floor: { r: 80, g: 65, b: 70 },    accent: { r: 180, g: 30, b: 40   } };
// lich_sanctum: necrotic purple walls, bone white floor, sickly green accents
THEME_COLORS.lich_sanctum    = { wall: { r: 40, g: 25, b: 50 },     floor: { r: 120, g: 115, b: 105 }, accent: { r: 80, g: 200, b: 60   } };
// cogwork_foundry: bronze walls, iron grey floor, steam white accents
...
THEME_COLORS.spider_hive     = { wall: { r: 40, g: 35, b: 30 },     floor: { r: 150, g: 145, b: 140 }, accent: { r: 120, g: 200, b: 50  } };
// sunken_depths: deep ocean walls, seabed floor, bioluminescent accents
THEME_COLORS.sunken_depths   = { wall: { r: 15, g: 30, b: 55 },     floor: { r: 40, g: 60, b: 50 },    accent: { r: 50, g: 220, b: 180  } };
// abyssal_dark: pitch black walls, dark grey floor, faint ember accents
THEME_COLORS.abyssal_dark    = { wall: { r: 8, g: 5, b: 8 },        floor: { r: 25, g: 22, b: 25 },    accent: { r: 60, g: 30, b: 15    } };
// werewolf_den: dark earth walls, packed dirt floor, moonlight silver accents
THEME_COLORS.werewolf_den    = { wall: { r: 55, g: 40, b: 30 },     floor: { r: 100, g: 80, b: 60 },   accent: { r: 180, g: 190, b: 210 } };
// troll_caves: mossy stone walls, muddy floor, bile yellow accents
THEME_COLORS.troll_caves     = { wall: { r: 50, g: 55, b: 40 },     floor: { r: 80, g: 70, b: 50 },    accent: { r: 170, g: 180, b: 40  } };
// ruined_village: crumbling stone walls, cobblestone floor, faded wood accents
THEME_COLORS.ruined_village  = { wall: { r: 90, g: 80, b: 70 },     floor: { r: 140, g: 130, b: 115 }, accent: { r: 130, g: 100, b: 60  } };

// ---------------------------------------------------------------------------
// Add new themes to category lists
// ---------------------------------------------------------------------------

CASTLE_THEMES.push('iron_forge', 'haunted_manor');
...
// ---------------------------------------------------------------------------
// Extend BIOME_DUNGEON_THEMES to include new themes
// ---------------------------------------------------------------------------

// Biome 0: WATER — tidal_vault, sunken_depths added
BIOME_DUNGEON_THEMES[0] = ['coral_grotto', 'flooded_ruins', 'tidal_vault', 'sunken_depths'];
// Biome 1: DESERT — mirage_palace added
BIOME_DUNGEON_THEMES[1] = ['sand_tomb', 'ancient_library', 'mirage_palace'];
// Biome 2: MOUNTAIN — iron_forge, ashen_observatory, frost_citadel, puzzle_labyrinth, infernal_pit, dragons_den, spider_hive, abyssal_dark, troll_caves added
BIOME_DUNGEON_THEMES[2] = ['crystal_cavern', 'frozen_depths', 'iron_forge', 'ashen_observatory', 'frost_citadel', 'puzzle_labyrinth', 'infernal_pit', 'dragons_den', 'spider_hive', 'abyssal_dark', 'troll_caves'];
// Biome 3: SCORCHED_SANDS — mirage_palace, ashen_observatory, infernal_pit, dragons_den added
BIOME_DUNGEON_THEMES[3] = ['lava_rift', 'sand_tomb', 'mirage_palace', 'ashen_observatory', 'infernal_pit', 'dragons_den'];
// Biome 4: STEPPES — orc_barrow, lich_sanctum, abyssal_dark, werewolf_den, troll_caves added
BIOME_DUNGEON_THEMES[4] = ['bone_yard', 'shadow_realm', 'orc_barrow', 'lich_sanctum', 'abyssal_dark', 'werewolf_den', 'troll_caves'];
// Biome 5: FOREST — elven_reliquary, goblin_warrens, plague_warren, dinosaur_jungle, spider_hive, werewolf_den, troll_caves, ruined_village added
BIOME_DUNGEON_THEMES[5] = ['fungal_forest', 'overgrown_temple', 'elven_reliquary', 'goblin_warrens', 'plague_warren', 'dinosaur_jungle', 'spider_hive', 'werewolf_den', 'troll_caves', 'ruined_village'];
// Biome 6: PLAINS — haunted_manor, vampire_castle, werewolf_den, ruined_village added
BIOME_DUNGEON_THEMES[6] = ['stone_keep', 'overgrown_temple', 'haunted_manor', 'vampire_castle', 'werewolf_den', 'ruined_village'];
// Biome 7: SWAMP — plague_warren, sunken_cathedral, goblin_warrens, vampire_castle, dinosaur_jungle, spider_hive added
BIOME_DUNGEON_THEMES[7] = ['flooded_ruins', 'fungal_forest', 'plague_warren', 'sunken_cathedral', 'goblin_warrens', 'vampire_castle', 'dinosaur_jungle', 'spider_hive'];
// Biome 8: HOLY_DOMINION — sunken_cathedral, haunted_manor, puzzle_labyrinth, celestial_spire, vampire_castle, lich_sanctum, ruined_village added
BIOME_DUNGEON_THEMES[8] = ['catacombs', 'throne_dungeon', 'sunken_cathedral', 'haunted_manor', 'puzzle_labyrinth', 'celestial_spire', 'vampire_castle', 'lich_sanctum', 'ruined_village'];
// Biome 9: GNOMISH_ISLES — gnomish_workshop, tidal_vault, puzzle_labyrinth, cogwork_foundry added
BIOME_DUNGEON_THEMES[9] = ['clockwork_maze', 'crystal_cavern', 'gnomish_workshop', 'tidal_vault', 'puzzle_labyrinth', 'cogwork_foundry'];
// Biome 10: MECHSPIRE — gnomish_workshop, iron_forge, cogwork_foundry added
BIOME_DUNGEON_THEMES[10] = ['clockwork_maze', 'armory_vault', 'gnomish_workshop', 'iron_forge', 'cogwork_foundry'];
// Biome 11: CLOCKWORK_HARBOR — gnomish_workshop, tidal_vault, cogwork_foundry added
BIOME_DUNGEON_THEMES[11] = ['clockwork_maze', 'coral_grotto', 'gnomish_workshop', 'tidal_vault', 'cogwork_foundry'];
// Biome 12: WASTES — orc_barrow, goblin_warrens, ashen_observatory, infernal_pit, lich_sanctum, astral_rift, abyssal_dark added
BIOME_DUNGEON_THEMES[12] = ['bone_yard', 'sand_tomb', 'orc_barrow', 'goblin_warrens', 'ashen_observatory', 'infernal_pit', 'lich_sanctum', 'astral_rift', 'abyssal_dark'];
// Biome 13: BEACH — tidal_vault, sunken_depths added
BIOME_DUNGEON_THEMES[13] = ['coral_grotto', 'flooded_ruins', 'tidal_vault', 'sunken_depths'];
// Biome 14: FROSTBOUND — frost_citadel, dragons_den added
BIOME_DUNGEON_THEMES[14] = ['frozen_depths', 'crystal_cavern', 'frost_citadel', 'dragons_den'];
// Biome 15: SOUTHERN_WASTES — ashen_observatory, orc_barrow, astral_rift added
BIOME_DUNGEON_THEMES[15] = ['bone_yard', 'shadow_realm', 'ashen_observatory', 'orc_barrow', 'astral_rift'];
// Biome 16: ELVEN_SOUTH — elven_reliquary, celestial_spire, dinosaur_jungle added
BIOME_DUNGEON_THEMES[16] = ['overgrown_temple', 'fungal_forest', 'elven_reliquary', 'celestial_spire', 'dinosaur_jungle'];
...
// Theme -> preferred layouts (first = most likely, weighted selection)
...
function selectLayout(theme, rng) {
  ...
  if (!layouts || layouts.length === 0) {
    return FLOOR_LAYOUTS.BSP_ROOMS;
  }
  var totalWeight = 0;
...
function getEnemyPool(theme) {
  if (ENEMY_POOLS[theme]) return ENEMY_POOLS[theme];
  var fallback = THEME_POOL_FALLBACK[theme];
  if (fallback && ENEMY_POOLS[fallback]) return ENEMY_POOLS[fallback];
  return ENEMY_POOLS.stone_keep;
}
...
function generateFormInteractables(floor, rng) {
  ...
  for (var i = 0; i < count; i++) {
    ...
    while (!placed && attempts < maxAttempts) {
      ...
      if (floor.grid[py][px] !== TILE.FLOOR) continue;
...
function generateAnimalNpcs(floor, rng) {
  ...
  for (var i = 0; i < count; i++) {
    ...
    while (!placed && attempts < 20) {
      ...
      if (floor.grid[ay][ax] !== TILE.FLOOR) continue;
      var posKey = ax + ',' + ay;
      if (usedPositions[posKey]) continue;
